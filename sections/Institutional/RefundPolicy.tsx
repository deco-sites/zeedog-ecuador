...
export default function RefundPolicy(
  { refundPolicy, title }: SectionProps<typeof loader>,
) {
  if (!refundPolicy || !refundPolicy.body) return null;
    ...
    <div class="flex flex-col gap-6 lg:gap-10 items-center justify-center container max-w-3xl mx-auto px-4 py-8">
      ...
      <div
        ...
        dangerouslySetInnerHTML={{
          __html: refundPolicy.body.replace(/\s{2,}|\n/g, "<br>"),
        }}
      />
    </div>
  );
...
export const loader = async (props: Props, _req: Request, ctx: AppContext) => {
  ...
  return {
    ...props,
    refundPolicy: shopInfo.refundPolicy,
  };
};
