...
export default function PrivacyPolicy(
  { privacyPolicy, title }: SectionProps<typeof loader>,
) {
  if (!privacyPolicy || !privacyPolicy.body) return null;
    ...
    <div class="flex flex-col gap-6 lg:gap-10 items-center justify-center container max-w-3xl mx-auto px-4 py-8">
      ...
      <div
        ...
        dangerouslySetInnerHTML={{
          __html: privacyPolicy.body.replace(/\s{2,}|\n/g, "<br>"),
        }}
      />
    </div>
  );
...
export const loader = async (props: Props, _req: Request, ctx: AppContext) => {
  ...
  return {
    ...props,
    privacyPolicy: shopInfo.privacyPolicy,
  };
};
